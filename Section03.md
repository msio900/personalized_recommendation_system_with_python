...
* 4_ 이웃을 고려한 CF[✏️](#4)
* 5_ 최적의 이웃 크기 결정[✏️](#5)
* 6_ 사용자의 평가 경향을 고려한 CF[✏️](#6)
* 7_ 그 외의 CF 정확도 개선 방법[✏️](#7)
* 8_ 사용자 기반 CF와 아이템 기반 CF[✏️](#8)
* 9_ 추천 시스템의 성과측정지표[✏️](#9)

## 0_ 들어가기 전에[📑](#contents)<a id='0'></a>

* 협업 필터링(Collaborative Filtering: CF) : 어떤 아이템에 대해 **비슷한 취향** 을 가진 사람들은 **다른 아이템 또한** 비슷한 취향을 가질 것이다. 

## 1_ 협업 필터링의 원리[📑](#contents)<a id='1'></a>
...
## 3_ 기본 CF 알고리즘[📑](#contents)<a id='3'></a>
...
## 4_ 이웃을 고려한 CF[📑](#contents)<a id='4'></a>
...
## 5_ 최적의 이웃 크기 결정[📑](#contents)<a id='5'></a>
...
## 6_ 사용자의 평가 경향을 고려한 CF[📑](#contents)<a id='6'></a>
...
## 7_ 그 외의 CF 정확도 개선 방법[📑](#contents)<a id='7'></a>
...
## 8_ 사용자 기반 CF와 아이템 기반 CF[📑](#contents)<a id='8'></a>
...
* 아이템 기반 CF
  ...
  ## 9_ 추천 시스템의 성과측정지표[📑](#contents)<a id='9'></a>
...
* `TPR`과 `FPR`
  ...
  * 현실에서는 TN이 너무 커지는 경향이 잇음 그래서 TN이 들어간 지표를 사용하기 어려움.
  * 아이템이 많은 시스템의 성과측정지표는 정밀도나, 재현율을 추천함.
